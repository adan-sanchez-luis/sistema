                                    ...
                                    <div class="col-md-4 mt-4">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control text-upper"
                                                ...
                                                name="direccion"><?php echo e(old('direccion',$cliente->direccion)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-md-4 mt-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="correo" value="<?php echo e(old('correo',$cliente->correo)); ?>"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sistema-ventas-neumaticos\resources\views/clients/edit.blade.php ENDPATH**/ ?>